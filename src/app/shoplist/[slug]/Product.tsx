      ...
      <div className="w-[100%] md:w-[50%] ">
        ...
        <div className="hidden lg:flex lg:flex-row flex-col justify-between">
          ...
          <div className="hidden lg:flex lg:gap-2 md:gap-5">
            <button className="text-[#828282] text-[14px] md:text-[18px] px-5 py-2 rounded-full hover:bg-[#FF9F0D] hover:text-white flex justify-center items-center transition-transform duration-200 ease-in transform hover:scale-105">
              <FaArrowLeft /> Prev
            </button>
            <button className="text-[#828282] text-[14px] md:text-[18px] px-5 py-2 rounded-full hover:bg-[#FF9F0D] hover:text-white flex justify-center items-center transition-transform duration-200 ease-in transform hover:scale-105">
              Next <FaArrowRight />
        ...
        <div>
          ...
          <div className="my-[26px] flex flex-col md:flex-row gap-[16px]">
            ...
            <button
              ...
              className="bg-[#FF9F0D] px-5 py-2 text-[12px] md:text-[16px] hover:bg-[#ffaf37] hover:text-white flex justify-center items-center transition-transform duration-200 ease-in transform hover:scale-105"
            >
              Add To Cart
            </button>
          </div>
          ...
          <div className="flex mt-[28px] items-center gap-[5px]">
            <h2 className="text-[#333333] text-[18px] font-normal">Share:</h2>
